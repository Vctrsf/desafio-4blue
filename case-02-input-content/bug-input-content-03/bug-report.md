...
**Severidade:** Alta — falha de validação crítica que compromete diretamente a segurança das contas dos usuários.
**Impacto:** Alto (permite criação de contas com senhas que não atendem à política de segurança)
